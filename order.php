      ...
      <div class="container-fluid" style="margin-top:100px">
        <div class="row mt-5">
          <div class="col-lg-8">
            ...
            <?php
                ...
                if(isset($_POST['login'])){
                	...
                	$query = $mysqli->query("select * from customer where c_email ='$email' AND c_pass ='$password'");
          ...
          <?php
             ...
             $mysqli = new mysqli("localhost","root","","foodstuff");
             $query = $mysqli->query("SELECT * FROM customer where c_email='$log'");
             ...
             <div class="card shadow-sm mt-3" style="width:100%">
               ...
               <?php
                    ...
                    $mysqli = new mysqli("localhost","root","","foodstuff");
                   $query = $mysqli->query("SELECT * FROM product inner join vendor on product.v_email=vendor.v_email WHERE p_id='$p_id'");
             ...
             <?php
                  if(isset($_POST['chng_add'])){
                    ...
                    $p_id=$_POST['p_id'];
                    $mysqli = new mysqli("localhost","root","","foodstuff");
                    $update = $mysqli->query("UPDATE customer
                    SET
                 ...
                 $id=date('Ymdhis');
                   if(isset($_POST['order'])){
                     ...
                     $mysqli = new mysqli("localhost","root","","foodstuff");
                     $insert = $mysqli->query("INSERT INTO orders (invoice_no,c_id,p_id,v_email,qty) values ('$id','$c_id','$p_id','$v_email','$qty')");
                           ...
                           <div class="card shadow">
                             ...
                             <div class="card-body">
                               <table style="width:100%">
                                 ...
                                 $id=$_GET['p_id'];
                                 $mysqli = new mysqli("localhost","root","","foodstuff");
                                 $p = $mysqli_->uery("SELECT * from product where p_id='$id'");
